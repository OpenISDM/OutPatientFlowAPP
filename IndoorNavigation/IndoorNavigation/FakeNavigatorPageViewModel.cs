...
// {
    ...
    // {
        ...
        // {
            ...
            // NavigationInstruction instruction = new NavigationInstruction();//= (args as Session.NavigationEventArgs)._nextInstruction;
        ...
        // //public NavigationInstruction GetNavigationInstruction(RegionWaypointPoint point, int nextStep)
        // //{
        // //    NavigationInstruction instruction = new NavigationInstruction() ;

        // //    instruction._currentWaypointName = _navigationGraph.GetWaypointNameInRegion(point._regionID, point._waypointID);
        // //    instruction._nextWaypointName=_navigationGraph.GetWaypointNameInRegion(_waypointsOnRoute[nextStep]._regionID)
        // //    return instruction;
        // //}
        ...
        // {
            // NavigationInstructions = new List<NavigationInstruction>();
