...
namespace IndoorNavigation
{
    ...
    public partial class SignInPage : ContentPage
    {
        ...
        async private void Button_Clicked(object sender, EventArgs e)
        {
            ...
            {
                await DisplayAlert(_resourceManager.GetString
                    ("ERROR_STRING", currentLanguage),
                    _resourceManager.GetString
                    ("IDNUM_TYPE_WRONG_STRING", currentLanguage)
        ...
        private void RgDayPicker_DateSelected(object sender,
